...
<form id="registro" >@csrf 
  {{-- action="guardardiscapacitado" method="POST" --}}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group lg-3">
                    <input class="form-control" type="text" name="nro_doc_identidad"
                        id="nro_doc_identidad" name="nro_doc_identidad" placeholder="Nro de documento..." required>
...
{{-- <form id="registro" action="guardardiscapacitado" method="POST">@csrf
                  ...
                  <div class="m-3 m-lg-5">
                      ...
                      <section data-step="1. Informacion personal">
                          <div class="row">
                              <h5>Personal</h5>
                              <div class="col-md-6">
                                  <label class="form-label" for="doc_identidad">Documento de identidad</label>
                                  <select class="form-select" aria-label="Default select example" name="doc_identidad"
                                      required>
                                      <option value="DNI">DNI</option>
                                  </select>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="input-group lg-3">
                                      <input class="form-control" type="text" name="nro_doc_identidad"
                                          id="nro_doc_identidad" name="nro_doc_identidad" placeholder="Nro de documento...">
                                      <button type="button" class="btn btn-primary" name="btnBuscar" id="btnBuscar"
                                          disabled><i class="lni lni-search"></i>Buscar</button>
                              ...
                              <div class="col-md-4">
                                  <label class="form-label" for="direccion">Direción</label>
                                  <input class="form-control" type="text" name="direccion" placeholder="Direción...">
                              </div>
                              <div class="col-md-4">
                                  <label class="form-label" for="distrito">Distrito</label>
                                  <select class="form-select" aria-label="Default select example" name="distrito">
                      ...
                      <section data-step="3. Datos personales">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-4">
                                  <label class="form-label" for="telefono_apoderado">Teléfono apoderado</label>
                                  <input class="form-control" type="email" name="telefono_apoderado"
                                      placeholder="Teléfono de apoderado...">
                              </div>
                              <div class="col-md-4">
                                <label class="form-label" for="seguro_salud">¿Cuenta con seguro de salud?</label>
    ...
    <script src="assets/app_js/discapacitados.js"></script>
  <script>
